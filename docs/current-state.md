...
- `parser-core` detects conservative email, integer, decimal, and phone-number field candidates with raw values, normalized values, confidence, reason codes, and byte-accurate source spans.
...
- Additional field candidate detection beyond email, integer, decimal, and phone-number values.
