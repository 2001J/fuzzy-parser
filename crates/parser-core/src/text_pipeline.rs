...
pub(super) fn not_applied_warning() -> ParserWarning {
    ParserWarning {
        code: "text_pipeline_not_applied".to_owned(),
        message: "text pipeline options were not applied because the document used the existing table parse path".to_owned(),
        location: None,
    }
}
